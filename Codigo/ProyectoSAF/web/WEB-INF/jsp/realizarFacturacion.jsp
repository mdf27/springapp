                                        ...
                                        <td width="70%">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody data-bind="foreach: renglonesFactura">
                                                    <tr>
                                                        <td ><strong data-bind="text: 0" /></td> <%--Cantidad --%>
...
// Para enter en buscar producto.
        ...
        function ViewModel() {
            ...
            //alert(self.cantProd);
            self.selectedResult = ko.observable(); // Producto seleccionado.
            self.selectResult = function(item) {
                self.selectedResult(item);
                self.renglonesFactura.push(item);
            ...
            self.realizarFactura = function(item) {
                ...
                alert(data);
                $.post("/realizarFactura", data, function(returnedData) {
        ...
        function renglonFactura(item) {
            var self = this;
            self.descripcion = ko.observable(item.descripcion);
            self.cantidadP = ko.observable(item.cant);
        }
