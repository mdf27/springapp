...
CREATE TABLE IF NOT EXISTS `safdb`.`Laboratorio` (
  ...
  UNIQUE INDEX `nombreCorto_UNIQUE` (`nombreCorto` ASC))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `safdb`.`PagoCuentaCorriente` (
  ...
  INDEX `fk_PagoCuentaCorriente_CuentaCliente1_idx` (`idCliente` ASC),
  CONSTRAINT `fk_PagoCuentaCorriente_CuentaCliente1`
    FOREIGN KEY (`idCliente`)
    REFERENCES `safdb`.`CuentaCliente` (`idCliente`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `safdb`.`Factura` (
  ...
  `idTransaccion` BIGINT NULL,
  PRIMARY KEY (`idTipoFactura`, `nroFactura`, `nroSerie`),
...
CREATE TABLE IF NOT EXISTS `safdb`.`RenglonFactura` (
  ...
  `idTransaccion` BIGINT NULL,
  PRIMARY KEY (`idRenglonFactura`, `idTipoFactura`, `nroFactura`, `nroSerie`),
  INDEX `fk_RenglonFactura_Factura1_idx` (`idTipoFactura` ASC, `nroFactura` ASC, `nroSerie` ASC),
  ...
  CONSTRAINT `fk_RenglonFactura_Factura1`
    FOREIGN KEY (`idTipoFactura` , `nroFactura` , `nroSerie`)
    REFERENCES `safdb`.`Factura` (`idTipoFactura` , `nroFactura` , `nroSerie`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `safdb`.`FormaPagoFactura` (
  ...
  `idTransaccion` BIGINT NULL,
  PRIMARY KEY (`idTipoFactura`, `nroSerie`, `nroFactura`),
  INDEX `fk_FormaPagoFactura_CuentaCliente1_idx` (`idCuentaCliente` ASC),
