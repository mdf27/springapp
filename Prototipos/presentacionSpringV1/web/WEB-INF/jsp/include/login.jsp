		...
		<form action="inicio.html" method="POST">
				...
				<p><input type="text" id="idUsuario" name="usuario" value="Codigo de usuario" onBlur="if(this.value=='')this.value='Codigo de usuario'" onFocus="if(this.value=='Codigo de usuario')this.value=''"></p> 				        
