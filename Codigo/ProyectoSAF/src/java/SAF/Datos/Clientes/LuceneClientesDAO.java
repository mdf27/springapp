...
public class LuceneClientesDAO extends AbstractDAO {
    ...
    public void crearIndiceClientesLuecene(Map<Integer, DatosCompletosClienteVO> clientes) throws ClassNotFoundException, SQLException, IOException, ParseException {
        ...
        while (it.hasNext()) {
            ...
            d.add(new org.apache.lucene.document.TextField("tieneCuenta", "" + rt.isTieneCuenta(), Field.Store.YES));
            if (rt.isTieneCuenta()) {
                ...
                d.add(new org.apache.lucene.document.TextField("saldo", "null", Field.Store.YES));
                d.add(new org.apache.lucene.document.TextField("tope", "null", Field.Store.YES));
                d.add(new org.apache.lucene.document.TextField("fCreacionCuenta", "null", Field.Store.YES));
    ...
    private void cargarListaClientes(Document d, List<DatosCompletosClienteVO> clientes) throws java.text.ParseException {
        ...
        boolean tieneCuenta = d.get("tieneCuenta").equals("true");
